# Contributing to AdditiveUI

## Introduction

### Welcome

Thank you for considering contributing to AdditiveUI.

Please know that everyone is welcome to contribute to AdditiveUI.
...
AdditiveUI is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to AdditiveUI,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/additive-ui/issues/new/choose) 
...
All changes to AdditiveUI source must go through the PR review process before
...
AdditiveUI is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/additive-ui.git
    ```
...
4. Build AdditiveUI from the command line by running:
